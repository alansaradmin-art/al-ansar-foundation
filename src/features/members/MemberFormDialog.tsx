...
function memberToFormValues(member: Member): Partial<MemberFormValues> {
  return {
    ...
    mobile_country: member.mobile_country ?? undefined,
    ...
    added_by_country: member.added_by_country ?? undefined,
    ...
    reference_contact_country: member.reference_contact_country ?? undefined,
